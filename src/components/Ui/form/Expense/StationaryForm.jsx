...
function StationaryForm({ fetchData }) {
        ...
        if (name === 'item') {
            setFormData((prevState) => ({
                ...
                additionalInfo: {
                    ...
                    item: value, // Update only the designation property
                },
            }));
        } else {
            setFormData((prevState) => ({
    ...
    return (
        <div className=" bg-white w-[400px] h-[420px] rounded-lg top-50 left-50 p-7 px-6">
            <div className="flex flex-row-reverse justify-between mb-8">
                ...
                <p className="font-bold">Add Stationery</p>
            </div>
                ...
                <form className="flex flex-col space-y-8" onSubmit={handleSubmit}>
                    ...
                    <div className=" flex  gap-8">
                        ...
                        <span className="relative   w-[50%]">
                            ...
                            <input type="text" value='Stationary Item' className="w-full text-xs p-2 border rounded border-[#c1bdbd]" />
                        </span>
                    </div>
                    <span className="relative">
                        <label className="absolute -top-4  pb-1 px-2 bg-white left-3 block text-xs">
                        ...
                        <input type="text" name="item" value={formData.additionalInfo.item} onChange={handleChange} className="w-full text-xs p-2 border rounded border-[#c1bdbd]" />
                    </span>
                    ...
                    <span className="relative">
                        ...
                        <input type="text" name=
                            "shortNarration" value={formData.shortNarration} onChange={handleChange} className="w-full text-xs p-2 border rounded border-[#c1bdbd]" />
                    </span>
