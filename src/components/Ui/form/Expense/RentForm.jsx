        ...
        if (name === 'rentName') {
            setFormData((prevState) => ({
                ...
                additionalInfo: {
                    ...
                    rentName: value, // Update only the designation property
                },
            }));
        } else {
            setFormData((prevState) => ({
    ...
    return (
        <div className=" bg-white w-[400px] h-[420px] rounded-lg top-50 left-50 p-7 px-6">
            <div className="flex flex-row-reverse justify-between mb-8">
                ...
                <p className="font-bold">Add Rent</p>
            </div>
                ...
                <form className="flex flex-col space-y-8" onSubmit={handleSubmit}>
                    ...
                    <div className=" flex  gap-8">
                        <span className="relative  w-[50%]">
                            ...
                            <input type="number" name="expensePrice" value={formData.expensePrice} onChange={handleChange} className="w-full  text-black text-xs p-2 border rounded border-[#c1bdbd]" />
                        </span>
                        <span className="relative   w-[50%]">
                            <label className="absolute -top-4  pb-1 px-2 bg-white left-3 block text-xs">
                                {'Expense Type'}:
                            </label>
                            <input type="text" value='Rent Cost' className="w-full  text-black text-xs p-2 border rounded border-[#c1bdbd]" />
                        </span>
                    </div>
                    <span className="relative">
                        <label className="absolute -top-4  pb-1 px-2 bg-white left-3 block text-xs">
                        ...
                        <input type="text" name="rentName" value={formData.additionalInfo.rentName} onChange={handleChange} className="w-full  text-black text-xs p-2 border rounded border-[#c1bdbd]" />
                    </span>
                    ...
                    <span className="relative">
                        ...
                        <input type="text" name="shortNarration" value={formData.shortNarration}  onChange={handleChange} className="w-full text-xs p-2 border  text-black rounded border-[#c1bdbd]" />
                    </span>
