...
import MaintainanceForm from "../../components/Ui/form/Expense/MaintainanceForm";
...
const Maintainance = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://localhost:8080/expenses/maintenance');
        ...
        <div className='block sm:flex relative '>
            {isFormOpen &&
                <div className={`absolute form-container bg-red-300 w-full h-screen`}>
                    {isEdit ? <UpdateExpense setIsEdit={setIsEdit} type={'Maintenance'} initialData={initialData} fetchData={fetchData} /> : <MaintainanceForm fetchData={fetchData} />}
                </div>
            }
            <div className='sm:flex-1'>
                <ExpenseLayout data={data} fetchData={fetchData} handleSearchChange={handleSearchChange} title={'Maintenance'}>
                    <div >
