...
import RentForm from "../../components/Ui/form/Expense/RentForm";
...
const Rent = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://localhost:8080/expenses/rent');
        ...
        <div className='block sm:flex relative'>
            {isFormOpen &&
                <div className={`absolute form-container bg-red-300 w-full h-screen`}>
                    {isEdit ? <UpdateExpense setIsEdit={setIsEdit} type={'Rent'} initialData={initialData} fetchData={fetchData} /> : <RentForm fetchData={fetchData} />}

                </div>
            }
            <div className='sm:flex-1'>
                <ExpenseLayout data={data} fetchData={fetchData} handleSearchChange={handleSearchChange} title={'Rent'}>
                    <div >
                            ...
                            <table className={styles.table}>
                                <thead>
                                    <tr className={styles.tr}>
                                        ...
                                        <th className={styles.th}>Rent Name</th>
                                ...
                                <tbody>
                                    {currentviewData.map((bill, index) => (
                                        <tr className='relative' key={bill._id}>
                                            ...
                                            <td className={styles.td}>{bill.additionalInfo?.rentName}</td>
