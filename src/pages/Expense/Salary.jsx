...
import SalaryForm from "../../components/Ui/form/Expense/SalaryForm";
...
const Salary = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://localhost:8080/expenses/salary');
        ...
        <div className='block sm:flex relative'>
            {isFormOpen &&
                <div className={`absolute form-container bg-red-300 w-full h-screen`}>
                    {isEdit ? <UpdateExpense setIsEdit={setIsEdit} type={'salary'} initialData={initialData} fetchData={fetchData} /> : <SalaryForm fetchData={fetchData} />}
                </div>
            }
            <div className='sm:flex-1'>
                <ExpenseLayout data={data} fetchData={fetchData} handleSearchChange={handleSearchChange} title={'Salary'}>
                    <div >
                                ...
                                <tbody>
                                    {currentviewData.map((bill, index) => (
                                        <tr className='relative' key={bill.id}>
                                            ...
                                            <td className={styles.td}>Lorem ipsum</td>
                                            <td className={styles.td}>{bill.additionalInfo?.designation}</td>
